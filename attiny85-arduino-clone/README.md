...
- J3: PB0..PB4, RESET, +3V3, and GND on a compact 2x4 2.54 mm header. It carries
  the complete AVR ISP pin set (PB0/MOSI, PB1/MISO, PB2/SCK, RESET), so the
  duplicate 2x3 ISP header J2 was removed as fully redundant.
