...
- Impact-based retest: rebuild and inspect only case-08 candidate `02`, plus its native Save/Close/Reopen/re-export if visually accepted. Cases 01–07 and unrelated historical gates are not affected. Case `09 atomic reroute — one net` remains next only after case 08 closes.
