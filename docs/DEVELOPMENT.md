...
The current source/package version is `0.2.1`. The public MCP contract remains 159 tools. `DipTraceService` is the stable public Facade; typed domain implementations live under `src/diptrace_mcp/services/`.
