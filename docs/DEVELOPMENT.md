...
future Python sources there. `plugin/dist/` is generated by PyInstaller, remains
ignored by Git, and is explicitly excluded from both static analyzers. PowerShell
build and installer scripts are outside the Python static-analysis scope.
