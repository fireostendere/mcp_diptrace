...
_READ_CAPABILITIES: dict[str, CapabilityRule] = {
    ...
    "builtin_library_catalog": CapabilityRule(),
...
_WRITE_CAPABILITIES: dict[str, CapabilityRule] = {
    ...
    "place_builtin_library_component": CapabilityRule("schematic"),
    ...
    "apply_schematic_placement_repair_plan": CapabilityRule("schematic"),
