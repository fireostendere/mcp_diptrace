---
name: controlled-impedance-review
description: "Orchestrate DipTrace MCP for Controlled Impedance Review: Review stackup, widths, gaps, reference layers, neck-downs, and transitions for controlled-impedance nets. Use when the user requests this workflow for a DipTrace schematic, PCB, library, review, or explicitly bounded project scope. Start with capability discovery; never simulate unavailable tools or write without a guarded preview."
---
...
Review stackup, widths, gaps, reference layers, neck-downs, and transitions for controlled-impedance nets.
...
4. Measure geometry and reference context.
5. Calculate analytical estimates.
6. Check neck-downs and transitions.
7. Compare targets.
8. Identify solver and fabricator confirmation requirements.
...
- The model and method are stated.
- Missing inputs are not invented.
- Analytical and solver results remain distinct.
...
> Run a controlled-impedance review for <nets/classes> against the current stackup.
