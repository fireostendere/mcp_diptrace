---
name: emc-emi-review
description: "Orchestrate DipTrace MCP for EMC/EMI Pre-Compliance Review: Identify emission and immunity risk mechanisms in the schematic and layout before laboratory testing. Use when the user requests this workflow for a DipTrace schematic, PCB, library, review, or explicitly bounded project scope. Start with capability discovery; never simulate unavailable tools or write without a guarded preview."
---

# EMC/EMI Pre-Compliance Review

## Purpose

Identify emission and immunity risk mechanisms in the schematic and layout before laboratory testing.

Priority: `P1`. Declared maturity: `heuristic`. Treat maturity as planning metadata, not runtime proof of availability.
...
- switching nodes and clocks
- ground, chassis, and enclosure
...
3. Identify high dV/dt and dI/dt sources.
4. Check loops and return paths.
5. Check connector filtering and ESD.
6. Check edge routing, plane gaps, and common-mode paths.
7. Check shielding and stitching.
8. Prioritize pre-compliance tests.
...
- No certification pass is promised.
- Findings identify a physical mechanism.
- Cable and enclosure assumptions are stated.
...
> Run an EMC/EMI pre-compliance review focused on <standard/subsystems>.
