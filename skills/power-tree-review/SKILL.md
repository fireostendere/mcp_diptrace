...
Build a directed power graph and review budgets, ratings, sequencing, protection, and reverse-current paths.
...
- schematic
- per-mode load data
- regulators and protection devices
...
3. Identify rails and sources.
4. Build the directed power graph.
5. Calculate current and power ranges.
6. Check ratings, dropout, and headroom.
7. Check sequencing and protection.
8. Derive placement and routing constraints.
...
- All consumers are accounted for.
- Unknown currents are explicit.
- A pass is never declared without required data.
...
> Build and review the project power tree, calculate rail budgets, and derive layout constraints.
