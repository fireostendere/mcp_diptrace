---
name: reverse-engineering-audit
description: "Orchestrate DipTrace MCP for Reverse-Engineering Audit: Reconstruct architecture, functional blocks, power tree, and critical paths without inventing design intent. Use when the user requests this workflow for a DipTrace schematic, PCB, library, review, or explicitly bounded project scope. Start with capability discovery; never simulate unavailable tools or write without a guarded preview."
---
...
Reconstruct architecture, functional blocks, power tree, and critical paths without inventing design intent.
...
3. Inventory documents and revisions.
4. Build connectivity graphs.
5. Cluster functional blocks.
6. Identify interfaces and critical paths.
7. Correlate layout evidence.
8. Record unknown intent and risks.
...
- Inferred intent is separated from connectivity facts.
...
> Audit the existing design and reconstruct architecture, power tree, interfaces, and explicit unknowns.
